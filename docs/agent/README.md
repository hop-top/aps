...
*   **Codebase Structure**: Overview of the standard package layout (`internal/core`, `internal/cli`, etc.).
*   **Design Patterns**: Standard patterns used (e.g., Capability Manager, Registry, Adapter Pattern for Isolation).
*   **Testing Strategy**: How to write and run Unit vs E2E tests.
...
*   **[Messenger Patterns](messenger-patterns.md)**: Adapter CLI usage, normalized message contract, and multi-messenger coordination for agents.
