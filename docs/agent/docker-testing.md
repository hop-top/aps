...
ls -la ~/.local/share/aps/profiles/test-agent/
...
- [Isolation Architecture](../specs/001-build-cli-core/isolation-architecture.md) - Isolation levels explained
- [Examples](../../README.md#quick-start) - Practical examples
