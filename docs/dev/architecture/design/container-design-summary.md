...
**Document**: `docs/dev/architecture/design/container-isolation-interface.md`
...
**Document**: `docs/dev/architecture/design/container-session-registry.md`
...
**Document**: `docs/dev/testing/container-test-strategy.md`
