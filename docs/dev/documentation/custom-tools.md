...
```bash
mkdir -p ~/.local/share/aps/profiles/my-profile/tools
```
...
```bash
# ~/.local/share/aps/profiles/my-profile/tools/my-tool.sh
#!/bin/bash
set -euo pipefail
...
Make it executable:
```bash
chmod +x ~/.local/share/aps/profiles/my-profile/tools/my-tool.sh
```

### Example: Python Script Tool

```python
# ~/.local/share/aps/profiles/my-profile/tools/my-python-tool.py
#!/usr/bin/env python3
...
```javascript
// ~/.local/share/aps/profiles/my-profile/tools/my-js-tool.js
#!/usr/bin/env node
...
```yaml
# ~/.local/share/aps/profiles/container-profile/profile.yaml
...
```bash
#!/bin/bash
# ~/.local/share/aps/profiles/my-profile/tools/env-tool.sh
...
**Solution**:
- Make script executable: `chmod +x <data>/profiles/my-profile/tools/my-tool.sh`
...
# Output saved to: ~/.local/share/aps/profiles/<profile-id>/Dockerfile
```
...
```yaml
# ~/.local/share/aps/profiles/my-profile/actions/use-tool.yaml
id: use-tool
