...
> Historical. Covers v0.2.x through v0.5.x (January 2026). Current release notes:
> [CHANGELOG.md](../../../../CHANGELOG.md), generated by release-please from
> Conventional Commits and never hand-edited.
