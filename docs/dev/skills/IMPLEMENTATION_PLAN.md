...
~/.agents/profiles/<profile-id>/skills/
  pdf-processing/
    SKILL.md
    scripts/
    references/
...
skills:
  ...
  telemetry:
    enabled: true
    event_log: ~/.agents/skills/usage.jsonl
    include_metadata: false
```

### Profile Config (~/.agents/profiles/myagent/profile.yaml)
...
# Location: ~/.agents/profiles/myagent/skills/my-action/
