...
- `internal/a2a/config_test.go` — `TestDefaultStorageConfig`, `TestValidateProfileConfig`, `TestValidateProfileConfig_Disabled`
- `internal/a2a/cache_test.go` — `TestNewCache`, `TestCache_GetMiss`, `TestCache_GetHit`, `TestCache_Invalidate`, `TestCache_Clear`, `TestCache_SetTTL`
