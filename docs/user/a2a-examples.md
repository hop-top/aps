...
# Edit ~/.agents/profiles/worker/profile.yaml and add:
# a2a:
#   enabled: true
...
**Solution**: Ensure the `~/.agents/a2a/` directory has proper permissions (0700) and your user owns it.
...
```
~/.agents/a2a/<profile-id>/tasks/<task-id>/
```
