...
func TestMobileDeviceIsExpired(t *testing.T) {
	t.Run("not expired", func(t *testing.T) {
		d := &mobile.MobileDevice{
...
func TestMobileDeviceIsActive(t *testing.T) {
...
func TestMobileErrors(t *testing.T) {
	...
	t.Run("ErrMobileDeviceNotFound", func(t *testing.T) {
		err := mobile.ErrMobileDeviceNotFound("dev-123")
		assert.Contains(t, err.Error(), "dev-123")
		assert.True(t, mobile.IsMobileError(err, mobile.ErrCodeDeviceNotFound))
	})

	t.Run("ErrMaxDevicesReached", func(t *testing.T) {
		err := mobile.ErrMaxDevicesReached("myagent", 10)
		assert.Contains(t, err.Error(), "maximum")
		assert.Contains(t, err.Error(), "10/10")
		assert.True(t, mobile.IsMobileError(err, mobile.ErrCodeMaxDevicesReached))
	})
